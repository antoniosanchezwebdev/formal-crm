...
<div class="container mx-auto">
    ...
    <form wire:submit.prevent="submit" autocomplete="off">
        ...
        <div class="mb-3 row d-flex align-items-center">
            ...
            <div class="col-sm-10" wire:ignore.self>
                <select id="denominacion" class="form-control js-example-responsive" wire:model="denominacion_id">
                    ...
                    <option value="nueva">-- Nueva denominación --</option>
        ...
        @if ($denominacion_id == 'nueva')
            <div class="mb-3 row d-flex align-items-center">
                <label for="nombre" class="col-sm-2 col-form-label">Nueva denominación</label>
                <div class="col-sm-10">
                    <input type="text" wire:model="nueva_denominacion" class="form-control" name="nueva_denominacion"
                        id="nueva_denominacion" placeholder="Denominación">
                    @error('nombre')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="mb-3 row d-flex align-items-center">
            <label for="precio" class="col-sm-2 col-form-label">Precio (Sin IVA)</label>
            <div class="col-sm-10">
                <input type="number" wire:model="precio" class="form-control" name="precio" id="precio"
                    placeholder="75.12..." step="0,01">
                @error('precio')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="mb-3 row d-flex align-items-center">
            ...
            <div class="col-sm-10">
                <input type="number" wire:model="duracion" class="form-control" name="duracion" id="duracion"
                    placeholder="8...">
                @error('duracion')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
