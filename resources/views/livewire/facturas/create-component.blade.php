    ...
    <form wire:submit.prevent="submit">
        ...
        @if ($estadoPresupuesto != 0)
            ...
            <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="col-sm-10">
                    <input readOnly type="text" placeholder="{{$presupuestoSeleccionado->detalles}}" class="form-control" name="detalles_presupuesto" id="detalles_presupuesto">
            ...
            <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="col-sm-10">
                    <input readOnly type="text" placeholder="{{$alumnoDePresupuestoSeleccionado->nombre}}" class="form-control" name="alumno" id="alumno">
                    @error('detalles_presupuesto') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="col-sm-10">
                    <input readOnly type="text" placeholder="{{$cursoDePresupuestoSeleccionado->nombre}}" class="form-control" name="curso" id="curso">
                    @error('detalles_presupuesto') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="col-sm-10">
                    <input readOnly type="text" placeholder="{{$presupuestoSeleccionado->total_sin_iva}}" class="form-control" name="total_sin_iva" id="total_sin_iva">
                    @error('detalles_presupuesto') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="col-sm-10">
                    <input readOnly type="text" placeholder="{{$presupuestoSeleccionado->iva}}" class="form-control" name="iva" id="iva">
                    @error('detalles_presupuesto') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="col-sm-10">
                    <input readOnly type="text" placeholder="{{$presupuestoSeleccionado->descuento}}" class="form-control" name="descuento" id="descuento">
                    @error('detalles_presupuesto') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="col-sm-10">
                    <input readOnly type="text" placeholder="{{$presupuestoSeleccionado->precio}}" class="form-control" name="precio" id="precio">
                    @error('detalles_presupuesto') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
            </div>
