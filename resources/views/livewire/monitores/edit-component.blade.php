    ...
    <form wire:submit.prevent="update">
        ...
        <div class="mb-3 row d-flex align-items-center">
            <div class="input-group">
                ...
                <input type="file" wire:model="file" class="form-control" name="firma" id="firma"
                    placeholder="">

                <button class="btn btn-outline-secondary" wire:click="save" type="button"
                    id="button-addon1">Actualizar
                    firma</button>
            </div>
        </div>
