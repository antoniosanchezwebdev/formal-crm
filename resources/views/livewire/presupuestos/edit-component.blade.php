...
<div class="container mx-auto">
    ...
    <br>
    <a href="/admin/presupuestos/pdf/{{ $identificador }}/false" class="btn btn-info text-white" target="_blank">Generar Presupuesto PDF</a>
    <a href="/admin/presupuestos/pdf/{{ $identificador }}/true" class="btn btn-info text-white" target="_blank">Generar Presupuesto PDF con impuestos</a>
    ...
    <div class="d-flex justify-content-evenly align-items-center mb-4">
        <div>
            <input type="radio" name="empresa" id="particular" value="1" class="form-check-input" wire:model="tipoCliente"> <span style="font-size: 1.4em;"> &nbsp; Particular</span>
        </div>
        <div>

            <input type="radio" name="empresa" id="empresa" value="2" class="form-check-input" wire:model="tipoCliente"> <span style="font-size: 1.4em;"> &nbsp; Empresa</span>
        </div>
    </div>

    <div class="card">
        <h4 class="card-header" style="border-bottom: 1px solid darkgray;">Datos básicos del presupuesto @if($tipoCliente == 1) para particular @else para empresa @endif</h4>
        <div class="card-body">
            <form wire:submit.prevent="update">
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                        <input type="date" wire:model.defer="fecha_fin" class="form-control" placeholder="18/02/2023" id="datepicker">
                        @error('fecha_fin')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                        ...
                        <table class="table" width="100%">
                            ...
                            <tr>
                                <td>
                                    <button type="button" class="btn btn-secondary" disabled>{{$rangoIndex + 1}}</button>
                                </td>
                                <td>
                                    <input type="date" wire:model="posibles_fechas.{{$rangoIndex}}.fecha_1" class="form-control">
                                    @error('numero_presupuesto')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </td>
                                <td class="col-sm-3">
                                    <input type="date" wire:model="posibles_fechas.{{$rangoIndex}}.fecha_2" class="form-control">
                                    @error('numero_presupuesto')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </td>
