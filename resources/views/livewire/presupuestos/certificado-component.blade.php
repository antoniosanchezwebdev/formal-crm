...
<body>
    ...
    <div class="contenedor-imagen">
        ...
        {{-- <p class="textoAcreditar">Acreditan en <strong> {{$cursoCelebracion}} a {{ $cursoFechaCelebracion }} </strong> que</p> --}}
        ...
        <img src="{{ assert("/public/$monitor->firma") }}" alt="Imagen de fondo" class="imagen-firma">
