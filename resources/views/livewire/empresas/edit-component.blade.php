    ...
    <br>
            ...
            <form wire:submit.prevent="update">
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                      <input type="text" wire:model="persona_contacto" class="form-control" name="persona_contacto" id="persona_contacto">
                      @error('persona_contacto') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>

                <div class="mb-3 row d-flex align-items-center">
                    <label for="persona_contacto_telefono" class="col-sm-2 col-form-label">Teléfono persona de contacto </label>
                    <div class="col-sm-10">
                      <input type="text" wire:model="persona_contacto_telefono" class="form-control" name="persona_contacto_telefono" id="persona_contacto_telefono">
                      @error('persona_contacto_telefono') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
