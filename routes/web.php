...
Route::group(['middleware' => 'is.facturacion', 'prefix' => 'facturacion'], function () {

    Route::get('inded', [BudgetController::class, 'index'])->name('budget.index');
...
Route::group(['middleware' => 'is.admin', 'prefix' => 'admin'], function () {
    ...
    Route::post('alumnos-doc', [AlumnoController::class, 'store'])->name("alumnos.upload_file");
    ...
    Route::get('monitores-edit/{id}', [MonitorController::class, 'edit'])->name('monitores.edit');
    ...
    Route::get('presupuestos/pdf/{id}/{iva}', [PresupuestoController::class, 'pdf'])->name('presupuestos.pdf');
    Route::get('presupuestos/firma', [PresupuestoController::class, 'firma'])->name('presupuestos.firma');
    Route::get('certificado/{id}/{alumno_id}/{curso_id}', [PresupuestoController::class, 'certificado'])->name('certificado.pdf');
